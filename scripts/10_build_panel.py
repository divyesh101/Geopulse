"""Phase 2 - build the dense (region x 15-min) demand panel with horizon targets.

    python scripts/10_build_panel.py --dev-sample          # verify on 7 days first
    python scripts/10_build_panel.py                       # full 2023-2024
    python scripts/10_build_panel.py --resolution 8        # override for the Phase 5 sweep
"""
