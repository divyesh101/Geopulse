"""Phase 3 gate check - the STOP-AND-VERIFY gate.

Phase 3 is the phase everything later rests on, so this checks the artifacts rather
than the training log, and fails loudly. Nothing from Phase 4 should start until this
prints 'gate PASSED'.

    python scripts/14_phase3_check.py
"""
