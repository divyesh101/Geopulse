"""Phase 1 / step 3 - pull hourly historical weather from the Open-Meteo archive.

Stored as tz-aware UTC so it joins directly against the UTC trip/panel grid.
The `weather_timestamp <= forecast_time` join rule is enforced in Phase 4, not here.

    python scripts/03_fetch_weather.py [--force]
"""
