"""A* pathfinding to the station you should actually walk to.

**The algorithm is the real one.** A* with an admissible haversine heuristic over an
...
derived from the demand forecast, so a dock 200 m further with bikes actually
arriving can win. That is the point of putting a forecast behind a router.
"""
