"""Chronological train / validate / test splits.

Splits are by **local calendar date**, never random. The test window (Nov-Dec 2024)
is opened exactly once, in Phase 7; `require_test=False` everywhere else means an
accidental read shows up as an explicit error rather than a quietly optimistic score.
"""
