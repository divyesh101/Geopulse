"""Data-quality profiling of the RAW trip table.

Runs *before* any row is removed, so the report describes the data as published and
every later drop is attributable to a named rule in :mod:`src.data.clean`.
"""
