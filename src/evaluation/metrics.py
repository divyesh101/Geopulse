...
MAE / RMSE / WAPE only. **MAPE is deliberately absent** - 71% of (region, bin) cells
have zero demand at H3-9, and MAPE is undefined there; any of the usual patches
(epsilon in the denominator, dropping zeros) silently changes what is being measured.
WAPE is the scale-free metric that survives zeros.
"""
